        ...
        if c == 0:  # linear
            ...
            if skalierung != '1' and skalierung != '2':
                ...
                if e > 30 * d:
                    master.destroy()
                    popup = Tk()
                    L = Label(popup, text='a darf höchstens 30 mal so groß, wie b sein, um eine optimale Skallierung zu erreichen').pack(side="top")
                    B = Button(popup, text='Ok', command=lambda: popup.destroy()).pack(side="top")
                    popup.mainloop()
                    ...
                    master.destroy()
                    popup = Tk()
                    L = Label(popup,text='a muss min. 1/10 von b betragen, um eine optimale Skallierung zu erreichen').pack(side="top")
                    B = Button(popup, text='Ok', command=lambda: popup.destroy()).pack(side="top")
                    popup.mainloop()
